 ...
 */
public class UpcomingMoviesFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void getUpcomingMovies() {
        Call<MovieResponse> call = mMovieDBApiInterface.getUpcomingMovies(API_KEY);
